...
export const BANKS = [
  { code: "0000", name: "BANCO REPUBLICA" },
  { code: "0001", name: "BANCO BOGOTA" },
  { code: "0002", name: "BANCO POPULAR" },
  { code: "0006", name: "BANCO CORPBANCA" },
  { code: "0007", name: "BANCOLOMBIA" },
  { code: "0009", name: "CITIBANK" },
  { code: "0012", name: "BANCO GNB SUDAM" },
  { code: "0013", name: "BBVA" },
  { code: "0014", name: "ITAU" },
  { code: "0019", name: "COLPATRIA" },
  { code: "0023", name: "BANCO OCCIDENTE" },
  { code: "0031", name: "BANCOLDEX" },
  { code: "0032", name: "BANCO CAJA SOCIAL" },
  { code: "0040", name: "BANCO AGRARIO" },
  { code: "0041", name: "JPMORGAN CORPOR" },
  { code: "0042", name: "BNP PARIBAS" },
  { code: "0050", name: "GRAN BANCO S.A." },
  { code: "0051", name: "DAVIVIENDA" },
  { code: "0052", name: "AV VILLAS" },
  { code: "0053", name: "BANCO W" },
  { code: "0058", name: "BANCO PROCREDIT" },
  { code: "0059", name: "BANCAMIA" },
  { code: "0060", name: "PICHINCHA" },
  { code: "0061", name: "COOMEVA" },
  { code: "0062", name: "FALABELLA S.A." },
  { code: "0063", name: "BANCO FINANDINA" },
  { code: "0064", name: "MULTIBANK" },
  { code: "0065", name: "BANCO SANTANDER" },
  { code: "0066", name: "BANCO COOPCENTRAL" },
  { code: "0067", name: "BANCO COMPARTIR" },
  { code: "0083", name: "COMPENSAR" },
  { code: "0084", name: "GEST Y CONTACTO" },
  { code: "0086", name: "ASOCAJAS" },
  { code: "0087", name: "FEDECAJAS" },
  { code: "0088", name: "SIMPLE S.A." },
  { code: "0089", name: "ENLACE OPERATIV" },
  { code: "0090", name: "CORFICOLOMBIANA" },
  { code: "0101", name: "ACH PSE" },
  { code: "0121", name: "FINAN JURISCOOP" },
  { code: "0283", name: "COOFINANTIOQUIA" },
  { code: "0289", name: "COTRAFA" },
  { code: "0292", name: "CONFIAR COOPERA" },
  { code: "0342", name: "SERVIFINANSA S.A" },
  { code: "0370", name: "COLTEFINANCIERA" },
  { code: "0502", name: "FIDUC SKANDIA" },
  { code: "0507", name: "BANCO NEQUI" },
  { code: "0550", name: "DECEVAL" },
  { code: "0551", name: "DAVIPLATA" },
  { code: "0683", name: "DIRECCION TESOR" },
  { code: "0685", name: "DGCPTN* -SISTEM" },
  { code: "0901", name: "VISA" },
  { code: "1083", name: "COMPENSAR S.A" },
];
